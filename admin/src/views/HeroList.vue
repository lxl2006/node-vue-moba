<template>
  <div>
    ...
    <el-table :data="items">
      ...
      <el-table-column prop="name" label="英雄名称" width="145"></el-table-column>
      <el-table-column prop="title" label="英雄外号" width="145"></el-table-column>
      <el-table-column prop="avator" label="英雄图标" width="150">
...
export default {
  ...
  methods: {
    async fetch() {
      const { data: res } = await this.axios.get("rest/heros");
      this.items = res;
    },
    async remove(row) {
